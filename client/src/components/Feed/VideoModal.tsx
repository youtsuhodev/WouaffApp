  ...
  return (
    <div className="modal-overlay active" onClick={onClose}>
      <div className="video-modal" onClick={e => e.stopPropagation()}>
        <button className="video-modal-close" onClick={onClose}><X size={22} /></button>
        ...
        <div className="video-modal-info">
          ...
          <div className="video-modal-actions">
            ...
            <button className="video-modal-action" onClick={() => { if (!showComments) loadComments(); setShowComments(!showComments); }}>
