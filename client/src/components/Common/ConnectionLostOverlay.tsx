...
import { onConnectionChange, offConnectionChange, isConnected } from '../../services/socket';
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/70 flex items-center justify-center">
      <div className="bg-[var(--bg-card)] rounded-2xl px-10 py-12 text-center max-w-[360px] w-[90%] shadow-[0_8px_32px_rgba(0,0,0,.4)]">
        <svg className="w-14 h-14 text-[var(--text-secondary)] mx-auto mb-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="text-sm text-[var(--text-secondary)]">
          Veuillez patienter, redémarrage en cours...
        </div>
      </div>
    </div>
  );
