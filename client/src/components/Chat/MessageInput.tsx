...
export default function MessageInput({
  inputValue, recording, recordingTime, showEmojiPicker, ephemeralDuration,
  onInputChange, onSend, onFileSelect, onStartRecording, onStopRecording,
  onToggleEmojiPicker, onEmojiSelect, onCloseEmojiPicker, onEphemeralChange, placeholder,
}: MessageInputProps) {
  ...
  return (
    <div className="msg-input-area">
      <input type="file" ref={fileInputRef} className="hidden" onChange={(e) => { const f = e.target.files?.[0]; if (f) { onFileSelect(f); e.target.value = ''; } }} />
      ...
      <div className="ephemeral-wrapper" ref={ephemeralPickerRef}>
        ...
        {ephemeralDuration && (
          <div className="ephemeral-active-indicator" onClick={() => { onEphemeralChange(null); setShowEphemeralPicker(false); }}>
