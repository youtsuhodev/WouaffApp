...
export default function ChatTopbar({ chatWithPseudo, currentGroupId, chatWith, searchOpen, onToggleSearch, onOpenGroupInfo, onOpenUserProfile, onDeleteConv }: ChatTopbarProps) {
  return (
    <div className="chat-topbar">
      ...
      <div className="topbar-actions">
        ...
        {chatWith && (
          <CallButton targetUid={chatWith} pseudo={chatWithPseudo} />
        )}
